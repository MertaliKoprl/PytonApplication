...
graph_of_cities = {
    ...
    'ANKARA': ['KONYA','AKSARAY','KIRŞEHİR','KIRIKKALE','ÇANKIRI','BOLU','ESKİŞEHİR','AFYONKARAHİSAR'],
    ...
    'KONYA':['ANTALYA','KARAMAN','MERSİN','NİĞDE','AKSARAY','ANKARA','ESKİŞEHİR','AFYONKARAHİSAR','ISPARTA'],
...
for a in graph_of_cities:
    print("IL ADI ",a)
    for i in graph_of_cities[a]:
        print(i,",",end ='')
    print(" ")
    print(" ")
